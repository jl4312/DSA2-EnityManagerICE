...
void AppClass::InitVariables(void)
{
	...
	m_pSun = new MyPrimitive();
	m_pEarth = new MyPrimitive();
	m_pMoon = new MyPrimitive();
...
{
	//Sets the camera
	m_pCameraMngr->SetPositionAndTarget(vector3(0.0f, 25.0f, 0.0f), vector3(0.0f, 0.0f, 0.0f));

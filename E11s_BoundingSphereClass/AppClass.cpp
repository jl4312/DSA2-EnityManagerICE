...
void AppClass::Update(void)
{
	...
	m_pMeshMngr->AddSphereToQueue(glm::translate(IDENTITY_M4, m_pBS1->GetCenter()) * glm::scale(vector3(m_pBS1->GetRadius()) * 2.0f), v3Color, WIRE);
	m_pMeshMngr->AddSphereToQueue(glm::translate(IDENTITY_M4, m_pBS2->GetCenter()) * glm::scale(vector3(m_pBS2->GetRadius()) * 2.0f), v3Color, WIRE);
